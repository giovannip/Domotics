...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <?php echo $this->Html->css('../js/rs-plugin/css/settings.css'); ?>

        <?php echo $this->Html->css('freeze.css'); ?>

        <?php echo $this->Html->script('modernizr.custom.32033'); ?>

        <!--[if lt IE 9]>
          <script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv'); ?>
          <script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min'); ?>
        <![endif]-->
    ...
    <body>
        ...
        <div class="pre-loader">
            <div class="load-con">
                ...
                <?php echo $this->Html->image('freeze/logo.png', array('alt' => '', 'class' => 'animated fadeInDown'));?>                
                <div class="spinner">
                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">
                            <?php echo $this->Html->image('freeze/logo.png', array('alt' => '', 'class' => 'logo'));?>
                        </a>
                    </div>
                ...
                <div class="tp-banner" >
                    <ul>
                        ...
                        <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                            ...
                            <?php echo $this->Html->image('transparent.png', array('alt' => "slidebg1", 'data-bgfit' => "cover", 'data-bgposition' => "left top", 'data-bgrepeat' => "no-repeat"));?>
                            ...
                            <div class="tp-caption lfl fadeout hidden-xs"
                                ...
                                <?php echo $this->Html->image('freeze/Slides/hand-freeze.png', array('alt' => '', 'class' => ''));?>
                            </div>
                            ...
                            <div class="tp-caption lfl fadeout visible-xs"
                                 ...
                                 data-start="700"
                                 data-easing="Power4.easeOut">
                                <?php echo $this->Html->image('freeze/iphone-freeze.png', array('alt' => '', 'class' => ''));?>
                            </div>
                        ...
                        <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                            ...
                            <div class="tp-caption lfb fadeout hidden-xs"
                                 ...
                                 data-start="700"
                                 data-easing="Power4.easeOut">
                                <?php echo $this->Html->image('freeze/Slides/freeze-slide2.png', array('alt' => '', 'class' => ''));?>
                            </div>
                        ...
                        <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                            ...
                            <div class="tp-caption customin customout hidden-xs"
                                 ...
                                 data-start="700"
                                 data-easing="Power4.easeOut">
                                <?php echo $this->Html->image('freeze/Slides/family-freeze.png', array('alt' => '', 'class' => ''));?>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4" >
							<?php echo $this->Html->image('freeze/iphone-freeze.png', array('class' => "img-responsive scrollpoint sp-effect5", 'alt' => ""));?>
                        </div>
                            ...
                            <div class="review-filtering">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="review-person">
												...
												<?php echo $this->Html->image('http://api.randomuser.me/portraits/women/94.jpg', array('alt' => '', 'class' => 'img-responsive'));?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="review-person">
												...
												<?php echo $this->Html->image('http://api.randomuser.me/portraits/men/70.jpg', array('alt' => '', 'class' => 'img-responsive'));?>
                                ...
                                <div class="review rollitin">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="review-person">
												<?php echo $this->Html->image('http://api.randomuser.me/portraits/men/93.jpg', array('alt' => '', 'class' => 'img-responsive'));?>
                                            </div>
                                        </div>
                                        <div class="col-md-10">
                                            <div class="review-comment">
                ...
                <div class="container">
                    ...
                    <div class="slider filtering scrollpoint sp-effect5" >
                        <div class="one">
                            ...
                            <?php echo $this->Html->image('freeze/screens/profile.jpg', array('alt' => '', 'class' => ''));?>
                            <h4>Profile Page</h4>
                        </div>
                        <div class="two">
                            <?php echo $this->Html->image('freeze/screens/menu.jpg', array('alt' => '', 'class' => ''));?>
                            <h4>Toggel Menu</h4>
                        </div>
                        <div class="three">
                            <?php echo $this->Html->image('freeze/screens/weather.jpg', array('alt' => '', 'class' => ''));?>
                            <h4>Weather Forcast</h4>
                        </div>
                        <div class="one">
                            <?php echo $this->Html->image('freeze/screens/signup.jpg', array('alt' => '', 'class' => ''));?>
                            <h4>Sign Up</h4>
                        </div>
                        <div class="one">
                            <?php echo $this->Html->image('freeze/screens/calendar.jpg', array('alt' => '', 'class' => ''));?>
                            <h4>Event Calendar</h4>
                        </div>
                        <div class="two">
                            <?php echo $this->Html->image('freeze/screens/options.jpg', array('alt' => '', 'class' => ''));?>
                            <h4>Some Options</h4>
                        </div>
                        <div class="three">
                            <?php echo $this->Html->image('freeze/screens/sales.jpg', array('alt' => '', 'class' => ''));?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                                <?php echo $this->Html->image('freeze/freeze-angled2.png', array('alt' => '', 'class' => ''));?>
                            </div>
                            <div class="platforms">
        ...
        <?php echo $this->Html->script('slick.min'); ?>
        <?php echo $this->Html->script('placeholdem.min'); ?>
        <?php echo $this->Html->script('rs-plugin/js/jquery.themepunch.plugins.min'); ?>
        <?php echo $this->Html->script('rs-plugin/js/jquery.themepunch.revolution.min'); ?>
